...
@oclif/example-multi-js/1.0.4 (linux-x64) node-v9.5.0
...
_See code: [@oclif/example-multi-js](https://github.com/oclif/example-multi-js/blob/v1.0.4/src/commands/hello.js)_
