...
@oclif/example-multi-js/1.7.48 linux-x64 node-v10.3.0
...
_See code: [src/commands/goodbye.js](https://github.com/oclif/example-multi-js/blob/v1.7.48/src/commands/goodbye.js)_
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-multi-js/blob/v1.7.48/src/commands/hello.js)_
