...
@oclif/example-multi-js/1.3.10 (linux-x64) node-v9.8.0
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-multi-js/blob/v1.3.11/src/commands/hello.js)_
