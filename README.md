...
@oclif/example-multi-js/1.4.4 linux-x64 node-v9.9.0
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-multi-js/blob/v1.4.4/src/commands/hello.js)_
