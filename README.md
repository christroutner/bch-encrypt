...
@oclif/example-multi-js/1.7.8 linux-x64 node-v9.10.0
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-multi-js/blob/v1.7.8/src/commands/hello.js)_
