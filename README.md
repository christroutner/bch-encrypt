...
@oclif/example-multi-js/1.7.13 linux-x64 node-v9.10.1
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-multi-js/blob/v1.7.13/src/commands/hello.js)_
