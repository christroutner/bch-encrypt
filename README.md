...
@oclif/example-multi-js/1.2.11 (linux-x64) node-v9.5.0
...
_See code: [src/commands/hello.js](https://github.com/oclif/example-multi-js/blob/v1.2.11/src/commands/hello.js)_
